...
(function () {
	...
	a.init = function() {
		...
		root.context = root.context || new (window.AudioContext || window.webkitAudioContext)();
	...
	a.bind = function() {
		...
		$('.icon-github2').on(click, function() { window.open('http://github.com/HengruiCao/musiccomp','_blank'); });
